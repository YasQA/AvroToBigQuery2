...
public class Client extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7046357284633425088L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Client\",\"namespace\":\"com.yaslebid.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"phone\",\"type\":[\"string\",\"null\"]},{\"name\":\"address\",\"type\":[\"string\",\"null\"]}]}");
   ...
   */
  public static com.yaslebid.avro.Client.Builder newBuilder() {
    return new com.yaslebid.avro.Client.Builder();
  }
   ...
   * @return A new Client RecordBuilder
   */
  public static com.yaslebid.avro.Client.Builder newBuilder(com.yaslebid.avro.Client.Builder other) {
    if (other == null) {
      return new com.yaslebid.avro.Client.Builder();
    } else {
      return new com.yaslebid.avro.Client.Builder(other);
    }
  }
   ...
   * @return A new Client RecordBuilder
   */
  public static com.yaslebid.avro.Client.Builder newBuilder(com.yaslebid.avro.Client other) {
    if (other == null) {
      return new com.yaslebid.avro.Client.Builder();
    } else {
      return new com.yaslebid.avro.Client.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Client>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.yaslebid.avro.Client.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.yaslebid.avro.Client other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.yaslebid.avro.Client.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.yaslebid.avro.Client.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.yaslebid.avro.Client.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.yaslebid.avro.Client.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.yaslebid.avro.Client.Builder setPhone(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.yaslebid.avro.Client.Builder clearPhone() {
      phone = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.yaslebid.avro.Client.Builder setAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.yaslebid.avro.Client.Builder clearAddress() {
      address = null;
